...
{
    public class AzureAISqlServerSearchServicesBO : IAzureAISqlServerSearchServicesBO
    {
        ...
        public AzureAISqlServerSearchServicesBO(IConfigurationSettings configuration)
        {
